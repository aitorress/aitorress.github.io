# Revision Plan: Of MCPs and Skills (Pass 2)

Source: _drafts/2026-02-09-the-great-unbundling-of-mcp/article.md
Critique: _drafts/2026-02-09-the-great-unbundling-of-mcp/critique-2.md
Date: 2026-02-11
...
- **Suggested fix:** Cut entirely. The article already defines skills through use ("a markdown file that teaches the agent what to do") and MCP through contrast ("the execution layer"). If the author wants to keep it, reduce to one sentence or push to a footnote.
...
- **Suggested fix:** Keep the fragment list and the typosquatting detail (specific, surprising). Cut or compress the "attack vector was straightforward" explanation. The fragments already imply the severity.
...
- **Suggested fix:** Break after "gave them back." New paragraph starts: "A skill is a markdown file. An MCP server is a service."
...
- **Suggested fix:** Add a short transitional sentence before the SOAP/REST paragraph, or add one sentence of implication after the paradox before moving on. Even a line break would help.
...
- **Suggested fix:** Keep "I'd bet" (Housel is right that it earns trust). Consider whether "Here's the thing, though" can be tightened or cut. "But open a skill catalog..." might be enough.
- **Questions to resolve:** Author preference. This is a tone call.
