...
### 2. "Both Camps, Same Mistake"

**Purpose:** Name the two echo chambers. Establish frustration, not neutrality. Set up the asymmetry — both are wrong, but one is more fundamentally wrong.
...
**Failure cases.** Meta replaced Instagram's search bar with AI chat. Viral backlash — 100K+ likes on a single TikTok criticizing it. Users described it as making search "so much worse." LinkedIn added AI-generated questions so generic they became memes: "What does a barber do?" Fortune called it "a cesspool of AI crap." Quietly removed. Both companies broke the front door to install an escape hatch nobody wanted.
...
### 5. "Developers Solved This in 1984"

**Purpose:** Ground the argument in 40 years of precedent. This isn't speculation — it's history replaying.

**Content:** The command line never died. Despite 40 years of GUI dominance, developers still use both — and they don't think about it. VS Code is the front door. The integrated terminal is the escape hatch. They move between them dozens of times a day. GUI for discovery and visual tasks. CLI for precision, automation, and everything the GUI can't anticipate.

The irony: the people most skeptical of AI interfaces (designers) don't have escape hatches in their tools. The people most enthusiastic (developers) already do. The debate splits along the line of who already has the thing. AI-vs-UI is CLI-vs-GUI Round 2, now going mainstream.

**Estimated length:** Medium. 150-200 words. Tight. The parallel makes itself.

**Sources:** CLI/GUI research, draft adjacent ideas

---

### 6. "The Escape Hatch Only Works If You Know the Building"

**Purpose:** Engage honestly with the strongest counterargument. Earn credibility by naming the real limitation — then show it *strengthens* the thesis.

**Content:** Here's the hard part. Most users never find the escape hatch. Amazon Rufus proves it at scale — daily users couldn't even see the AI was there. An escape hatch that nobody reaches for is just a locked door with a fancy sign.

But this doesn't undermine the argument. It completes it. You can't escape-hatch your way into a product you've never explored. The front door isn't just aesthetically nice — it's functionally necessary for users to discover what's possible. Without it, users bounce or underuse. The escape hatch only matters once you know the building well enough to need an exit.

This is why the front door is primary. Not because AI doesn't work. Because AI works best when it has context — and context is what a good UI provides.

**Estimated length:** Medium. 150-200 words. The turn should feel earned, not forced.

**Sources:** Draft Devil's Advocate, Amazon Rufus data, author input

---

### 7. [No heading — the close]

**Purpose:** Land the argument. A stance, not a summary. No hedging, no reconciliation.

**Content:** The front door is where the taste lives. The escape hatch is where the power lives. You need both. But you walk into a building through the front door, not the fire exit.

Start there.

**Estimated length:** Short. 3-4 sentences. The piece earns a short close by doing the work in the middle.

**Sources:** Draft raw material ("the front door is where the taste lives"), author input
...
- **Hybrid vigor analogy** — Weakest of the adjacent ideas. "Shallow gene pool" is a loaded metaphor that distracts. The CLI parallel does the same work better.
- **Design roles splitting** — Tangential. The piece is about the user experience, not the org chart.
- **Most of the effects lists (8 of 10)** — The strongest effects (products feeling magical, AI-wrapper collapse, feature discovery changing) are woven into the evidence sections rather than listed. The rest are cut.
- **"AI-native generation" prediction** — Speculative and unsupported. Either needs evidence or a more honest framing. Neither fits the piece's tone.
- **Accessibility angle** — Raised but unresolved in the draft. It's either a full paragraph that grapples with the tradeoff or it's cut. Cut — it's a different article.
- **Documentation as moat, analytics gets harder** — Operational details for a different audience.
- **Christopher Alexander parallel** — Tempting but redundant with CLI/GUI. Alexander is prettier; CLI/GUI is more concrete and carries evidence.
- **Krug's "Don't Make Me Think" update** — Clever observation but feels like a sidebar. Could be a tweet, not a section.
- **Questions 5-7** (airports, good taste, moral hazard) — Too diffuse. Good follow-up posts. Not this one.

### Cut from research

- **Stack Overflow developer survey specifics** — The CLI/GUI section covers the developer angle without needing more data.
- **Notion revenue details** — Inside baseball. Only the adoption pattern matters.
...
**A: Open with CLI/GUI history, then bring it forward.** "In 1984, the Macintosh introduced the GUI. People said the command line was dead..." More essay-like but delays the emotional hook. Rejected — author input says lead with frustration, not history.
